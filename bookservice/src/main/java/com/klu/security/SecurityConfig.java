    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http
            ...
            .authorizeHttpRequests(auth -> auth
                ...
                // Borrow and return operations allowed for students and librarians
                .requestMatchers(HttpMethod.PUT, "/books/*/borrow", "/books/*/return").hasAnyRole("STUDENT", "LIBRARIAN")

                // Inventory management strictly restricted to librarians
